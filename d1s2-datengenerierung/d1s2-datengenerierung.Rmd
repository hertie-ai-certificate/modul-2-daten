...
2. [Was bei der Datengenerierung schiefgehen kann](#dataflaws)
    ...
    2.2 [Fehlerhafte Messung](#measurement)
...
<table>
    ...
    <tbody>
        <tr>
            <td>Prozessproduzierte Daten</td>
            <td>
                <ul>
...
---
# Datengenerierungs-Fails

| **Kategorie**               | **Probleme**                                                                                                                                                                       | **Beispiele**                                                                                                                                                    |
|-----------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Datenerfassung**           | <ul><li>Unvollständige Daten</li><li>Verzerrte Stichproben</li><li>Messfehler</li></ul>                                                   | <ul><li>Sensoren fallen temporär aus, und es fehlen Daten aus bestimmten Zeiträumen</li><li>Befragungen schließen bestimmte Altersgruppen aus</li><li>Falsche Standortdaten durch GPS-Ausfälle</li></ul> |
| **Datenverarbeitung**        | <ul><li>Veraltete Daten</li><li>Falsch klassifizierte Daten</li><li>Daten-Duplikate</li><li>Datenrauschen</li></ul>                          | <ul><li>Veraltete Bevölkerungsdaten beeinflussen Planungen für neue Schulen</li><li>Automatische Tagging-Systeme klassifizieren Inhalte falsch</li><li>Dopplungen in Kundenlisten verfälschen Marketing-Analysen</li></ul> |
| **Datenverwaltung**          | <ul><li>Fehlende Datenethik</li></ul>                                                                                                      | <ul><li>Datensammlung ohne Einwilligung der Nutzer</li><li>Diskriminierung durch unethische Datenverwendung in HR-Systemen</li></ul>                                                                           |
| **Datenintegration**         | <ul><li>Inkompatible Datenformate</li></ul>                                                                                                 | <ul><li>Daten aus verschiedenen Datenbanken (z. B. Excel und SQL) lassen sich nicht ohne Weiteres integrieren</li><li>Unterschiedliche Zeitzonenformate in einer globalen Analyse</li></ul>                    |
| **Datenanalyse**             | <ul><li>Bias in Trainingsdaten</li></ul>                                                                                                    | <ul><li>Historische Datensätze zu Straftaten enthalten rassistische Vorurteile, die in einem KI-System zur Kriminalitätsvorhersage reproduziert werden</li></ul>                                                |
| **Datenmanagement**          | <ul><li>Schlechte Datenorganisation</li><li>Fehlende Metadaten</li></ul>                                                                    | <ul><li>Keine klare Benennung oder Strukturierung der Datenfelder</li><li>Wichtige Informationen zur Datenherkunft oder -bedeutung fehlen in der Dokumentation</li></ul>                                       |
| **Datenqualitätssicherung**  | <ul><li>Mangelhafte Validierung</li><li>Keine Überprüfung von Ausreißern</li></ul>                                                           | <ul><li>Keine automatisierten Prüfungen zur Erkennung von Fehlern</li><li>Ausreißer bleiben unentdeckt und verfälschen das Ergebnis</li></ul>                                                                  |
| **Datenaufbewahrung**        | <ul><li>Unzureichende Archivierung</li><li>Verlust von Daten</li></ul>                                                                      | <ul><li>Alte Daten werden unsachgemäß gelöscht oder nicht gesichert</li><li>Fehlende Backups führen zu Verlust von historischen Daten</li></ul>                                                                |
