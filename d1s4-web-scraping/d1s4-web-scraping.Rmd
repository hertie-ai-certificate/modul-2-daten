...
subtitle: "Session 4: Web Scraping und APIs (Praxis-Session)"
...
1. [Die Proliferation von Webdaten](#webdata)
...
# Die Proliferation von Webdaten
...
- Nicht alle Daten, die im Web verfügbar sind, sind „Webdaten“.
- Webdaten sind **Daten, die im, für oder über das Web erstellt werden**. Nach dieser Definition ist ein Umfragedatensatz, den Sie aus einem Datenspeicher herunterladen, keine Webdaten.
- Andererseits sind online erfasste Umfragedaten (d. h. Web-/Mobilfragebögen) Webdaten, die wir in der heutigen Sitzung jedoch nicht berücksichtigen.
- Beispiele für Webdaten: 
  ...
  - Daten aus Umfragen, Experimenten, Clickworkern
  - Einfach jede beliebige Website
]
